...
def main(config_path, base_path_to_store_results, tokenizer_path, tokenized_hf_dataset_path, pretrained_model_path=None,
    ...
    yes_token_id, no_token_id = convo_uncased_tokenizer('yes no')['input_ids'][0], \
        convo_uncased_tokenizer('yes no')['input_ids'][1]
    ...
    test_metrics, test_preds = trainer.test_as_lm(convo_wizard=convo_wizard, tokenized_test_data=tokenized_test_data,
